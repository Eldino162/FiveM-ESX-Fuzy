...
local suffix = "^0."
local messages = {
    'Message ^1SUPPORT  Discord --> discord.gg/Z8aYP2s',
    'Message ^2SUPPORT  Discord --> discord.gg/Z8aYP2s',
    'Message ^3SUPPORT  Discord --> discord.gg/Z8aYP2s',
    'Message ^4SUPPORT  Discord --> discord.gg/Z8aYP2s',
    'Message ^5SUPPORT  Discord --> discord.gg/Z8aYP2s',
    'Message ^6SUPPORT  Discord --> discord.gg/Z8aYP2s'
}
local ignorelist = {
    "ip:127.0.0.1",
